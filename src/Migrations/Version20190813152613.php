 ...
 */
final class Version20190813152613 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE inscription ADD annee_id INT NOT NULL, ADD code VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE inscription DROP annee_id, DROP code');
        $this->addSql('ALTER TABLE pansion DROP FOREIGN KEY FK_E24DDE6CA6CC7B2');
