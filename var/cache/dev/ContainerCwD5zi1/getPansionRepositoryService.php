...
// Returns the private 'App\Repository\PansionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PansionRepository.php';

return $this->privates['App\\Repository\\PansionRepository'] = new \App\Repository\PansionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
