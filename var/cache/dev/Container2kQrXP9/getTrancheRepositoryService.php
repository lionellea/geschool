...
// Returns the private 'App\Repository\TrancheRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TrancheRepository.php';

return $this->privates['App\\Repository\\TrancheRepository'] = new \App\Repository\TrancheRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
